...
class FabricanteController extends Controller {
	...
	public function index()
	{
		...
		// 'cachefabricantes' es la clave con la que se almacenaran los registros
		// obtenidos de Fabricante::all();
		$fabricantes = Cache::remember('cachefabricantes',15/60,function(){
			return Fabricante::all();
		});


		// Para devolver un JSON con código de respuesta HTTP SIN cache.
		//return response()->json(['status'=>'ok', 'data'=>Fabricante::all()],200);	


		// Para devolver un JSON con codigo de respuesta HTTP CON cache.
